...
puts "A sinifi tanimlaniyor"
class A
  attr :instance_variable

  CONSTANT = "#{self}_CONSTANT"
  @@class_variable = "#{self}_class_variable"
  @class_instance_variable = "#{self}class_instance_variable"
...
puts "B sinifi tanimlaniyor(degisiklik yapmadan)"
class B < A
end

puts "C sinifi tanimlaniyor(degisiklik yaparak)"
class C < A
  CONSTANT = "#{self}_CONSTANT"
